...
public class ModelMapperConfig {
	...
	ModelMapper createModelMapper() {
		...
		modelMapper.addConverter(BOOK_TO_BOOK_RESPONSE_CONVERTER,Book.class,BookResponse.class/* TODO: Add the corresponding converter here */);
		modelMapper.addConverter(BOOK_REQUEST_TO_BOOK_CONVERTER,BookRequest.class,Book.class/* TODO: Add the corresponding converter here */);
		return modelMapper;
	}
}
